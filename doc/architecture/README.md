...
| [ADR-0049](../adr/ADR-0049-gateway-session-absolute-max-age.md) | Gateway session absolute max-age — forces silent re-login every 30 minutes so a Keycloak role grant/revocation can't lag an already-logged-in session indefinitely |
