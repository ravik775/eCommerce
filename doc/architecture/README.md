...
| [ADR-0058](../adr/ADR-0058-resource-limit-and-startup-optimization.md) | ADR-0057's redeploy took 12+ min with restarts — docker stats showed all 4 services pinned at their 500m CPU limit throughout. Raised CPU limits to 1000m, widened liveness-probe timing (breaks the restart-loop-amplification), enabled spring.main.lazy-initialization; future multi-service redeploys will be staggered instead of simultaneous |
