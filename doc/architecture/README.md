...
| [ADR-0048](../adr/ADR-0048-force-trace-server-side-authorization.md) | Server-side authorization for the CAN_TRACE force-trace header — closes a real gap where the client-side UI gate was never actually enforced |
