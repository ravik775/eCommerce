...
| [ADR-0051](../adr/ADR-0051-spiffe-svid-rotation-hardening.md) | SPIFFE SVID rotation hardening — 30s reload interval (was 5min), proactive expiry-margin alerting, and GET-only gateway retry/backoff — root-caused via decompiling java-spiffe-core, not guessed |
